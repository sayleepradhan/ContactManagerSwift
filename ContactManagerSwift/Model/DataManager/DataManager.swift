...
class DataManager {
    ...
    /*******************************************************************************
     *  Name                : sharedInstance
     *  Purpose             : to create a shared instance
     *  Parametrs           :
     *  Return Values       : DataManager
     ********************************************************************************/
    ...
    //: MARK: Main Queue context
    private func mainQueueContext() -> NSManagedObjectContext {
    ...
    //: MARK: Core Data Stack iOS 9.0 and below
    
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file.
        // This code uses a directory named "com.sp.contactmanagerswift"
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        // This property is not optional. It is a fatal
        // error for the application not to be able to find and load its model.
        let modelURL = Bundle.main.url(forResource: "ContactManagerSwift", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("ContactManagerSwift.sqlite")
    ...
    //: MARK: Context for background queue
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "ContactManagerSwift")
